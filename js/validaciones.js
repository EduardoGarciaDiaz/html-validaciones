export function valida(input){
    const tipoDeInput = input.dataset.tipo; //Se obtiene del data atribute del html en cada input(data-tipo="NombreTipo")
...
function validarNacimiento(input){
    ...
    input.setCustomValidity(mensaje)//Define el mensaje de validacion dinamicamente
};
